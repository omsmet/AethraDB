...
import benchmarks.util.LongArrayPackageOperator;
...
public class NonVectorisedNonSimd extends ResultConsumptionTarget {
    ...
    @Param({
            ...
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_0.2",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_0.4",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_0.6",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_0.8",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_1.0",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_1.2",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_1.4",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_1.6",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_1.8",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_2.0",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_2.2",
            "/nvtmp/AethraTestData/aggregation_query_int/arrow_size_31457280_keys_262144_skew_2.4"
    })
    ...
    /**
     * State: the result of the query (null if the query has not been executed yet).
     */
    private long[] result;
     ...
     * The result is an integer array that should simply be written to the result field of {@code this}.
    ...
    public void trialSetup() throws Exception {
        ...
        CodeGenOperator<?> packageOperator = new LongArrayPackageOperator(plannedQuery, queryRootOperator, numberKeys * 4);
        ...
        this.resultVerifier = new ResultVerifier(this.tableFilePath, false);
    }
    ...
    public void teardown() {
        if (!this.resultVerifier.resultCorrect(result))
            throw new RuntimeException("The computed result is incorrect");
        result = null; // reset the result after verifying it
    }
