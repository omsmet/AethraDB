...
public class VectorisedSimd {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while (lineitem_doubles.loadNextBatch()) {
            ...
            projection_computation_result_length = VectorisedArithmeticOperators.subtract(projection_literal, lineitem_doubles_vc_1, projection_computation_result);
            int projection_computation_result_0_length;
            projection_computation_result_0_length = VectorisedArithmeticOperators.multiply(lineitem_doubles_vc_0, projection_computation_result, projection_computation_result_length, projection_computation_result_0);
            int projection_literal_0 = 1;
            int projection_computation_result_1_length;
            projection_computation_result_1_length = VectorisedArithmeticOperators.add(projection_literal_0, lineitem_doubles_vc_2, projection_computation_result_1);
            int projection_computation_result_2_length;
            projection_computation_result_2_length = VectorisedArithmeticOperators.multiply(projection_computation_result_0, projection_computation_result_0_length, projection_computation_result_1, projection_computation_result_1_length, projection_computation_result_2);
