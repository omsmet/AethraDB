...
public final class KeyMultiRecordMap_10523395 { // DIFF: generated class is private (as it is local)
    ...
    public KeyMultiRecordMap_10523395() {
        this(4);
    }
    public KeyMultiRecordMap_10523395(int capacity) {
