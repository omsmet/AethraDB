...
public final class KeyMultiRecordMap_1719746158 { // DIFF: generated class is private (as it is local)
    ...
    public KeyMultiRecordMap_1719746158() {
        this(4);
    }
    public KeyMultiRecordMap_1719746158(int capacity) {
