...
public class KeyMultiRecordMap_1541427914 { // DIFF: generated class is private (as it is local)
    ...
    public KeyMultiRecordMap_1541427914() {
        this(4);
    }
    public KeyMultiRecordMap_1541427914(int capacity) {
