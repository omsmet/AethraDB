...
import benchmarks.join_query_hard_coded.NonVectorisedNonSimdOptimisedSupport.InnerJoinMap;
import benchmarks.join_query_hard_coded.NonVectorisedNonSimdOptimisedSupport.OuterJoinMap;
...
public class NonVectorisedNonSimdHandOptimised {
...
//            "/nvtmp/AethraTestData/join_query_int_sf20/A_B_0.6_C_0.8",
    ...
    public void executeQuery() throws IOException {
        // DIFF: Manually optimised to count
        long count = 0;
        // DIFF: hard-coded
        // KeyMultiRecordMap_1519611492 join_map = new KeyMultiRecordMap_1519611492();
        // KeyMultiRecordMap_375951774 join_map_0 = new KeyMultiRecordMap_375951774();
        ...
        while (table_A.loadNextBatch()) {
            ...
            for (int aviv = 0; aviv < recordCount; aviv++) {
                ...
                join_map_0.associate(ordinal_value, left_join_key_prehash, ordinal_value, ordinal_value_0);
            }
        }
        // DIFF: hard-coded
        ...
        while (table_B.loadNextBatch()) {
            ...
            for (int aviv = 0; aviv < recordCount; aviv++) {
                ...
                for (int i = 0; i < left_join_record_count; i++) {
                    ...
                    join_map.associate(left_join_ord_1, left_join_key_prehash, left_join_ord_1);
                }
            }
        }
        // DIFF: hard-coded
