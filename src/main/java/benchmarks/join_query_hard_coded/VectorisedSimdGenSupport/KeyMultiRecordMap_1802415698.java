...
public final class KeyMultiRecordMap_1802415698 { // DIFF: generated class is private (as it is local)
    ...
    public KeyMultiRecordMap_1802415698() {
        this(4);
    }
    public KeyMultiRecordMap_1802415698(int capacity) {
