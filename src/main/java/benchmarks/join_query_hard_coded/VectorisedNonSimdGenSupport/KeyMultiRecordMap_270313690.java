...
public final class KeyMultiRecordMap_270313690 { // DIFF: generated class is private (as it is local)
    ...
    public KeyMultiRecordMap_270313690() {
        this(4);
    }
    public KeyMultiRecordMap_270313690(int capacity) {
