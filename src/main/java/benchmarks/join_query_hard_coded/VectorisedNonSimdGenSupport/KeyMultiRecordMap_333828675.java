package benchmarks.join_query_hard_coded.VectorisedNonSimdGenSupport;

import evaluation.general_support.hashmaps.Int_Hash_Function;

import java.util.Arrays;

public final class KeyMultiRecordMap_333828675 { // DIFF: generated class is private (as it is local)
    ...
    public KeyMultiRecordMap_333828675() {
        this(4);
    }
    public KeyMultiRecordMap_333828675(int capacity) {
        ...
        this.values_record_ord_3 = new int[capacity][2];
        this.values_record_ord_4 = new int[capacity][2];
        this.values_record_ord_5 = new int[capacity][2];
    ...
    private void growArrays() {
        ...
        int[][] new_values_record_ord_3 = new int[newSize][2];
        ...
        int[][] new_values_record_ord_4 = new int[newSize][2];
        ...
        int[][] new_values_record_ord_5 = new int[newSize][2];
