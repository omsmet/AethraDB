...
public class VectorisedSimd {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while (this.lineitem_table.loadNextBatch()) {
            ...
            projection_computation_result_length = VectorisedArithmeticOperators.multiplySIMD(lineitem_vc_1, lineitem_vc_2, ordinal_0_val_mask, ordinal_0_val_mask_length, projection_computation_result);
