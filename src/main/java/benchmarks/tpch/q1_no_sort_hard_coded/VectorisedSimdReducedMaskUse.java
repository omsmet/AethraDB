...
public class VectorisedSimdReducedMaskUse {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while (lineitem_table.loadNextBatch()) {
            ...
            // DIFF: removed mask
            projection_computation_result_length = VectorisedArithmeticOperators.subtractSIMD(projection_literal, lineitem_vc_2, projection_computation_result);
            ...
            // DIFF: removed mask
            projection_computation_result_1_length = VectorisedArithmeticOperators.subtractSIMD(projection_literal_0, lineitem_vc_2, projection_computation_result_1);
            int projection_computation_result_2_length;
            // DIFF: removed mask
            projection_computation_result_2_length = VectorisedArithmeticOperators.multiplySIMD(lineitem_vc_1, projection_computation_result_1, projection_computation_result_1_length,projection_computation_result_2);
            int projection_literal_1 = 1;
            int projection_computation_result_3_length;
            // DIFF: removed mask
            projection_computation_result_3_length = VectorisedArithmeticOperators.addSIMD(projection_literal_1, lineitem_vc_3, projection_computation_result_3);
