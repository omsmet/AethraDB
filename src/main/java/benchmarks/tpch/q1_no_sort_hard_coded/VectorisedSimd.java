...
public class VectorisedSimd {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        // DIFF: hard-coded
        // KeyValueMap_1487540468 aggregation_state_map = new KeyValueMap_1487540468();
        ...
        while (lineitem_table.loadNextBatch()) {
            ...
            projection_computation_result_length = VectorisedArithmeticOperators.subtractSIMD(projection_literal, lineitem_vc_2, ordinal_6_val_mask, ordinal_6_val_mask_length, projection_computation_result);
            int projection_computation_result_0_length;
            projection_computation_result_0_length = VectorisedArithmeticOperators.multiplySIMD(lineitem_vc_1, projection_computation_result, projection_computation_result_length, ordinal_6_val_mask, ordinal_6_val_mask_length, projection_computation_result_0);
            int projection_literal_0 = 1;
            int projection_computation_result_1_length;
            projection_computation_result_1_length = VectorisedArithmeticOperators.subtractSIMD(projection_literal_0, lineitem_vc_2, ordinal_6_val_mask, ordinal_6_val_mask_length, projection_computation_result_1);
            int projection_computation_result_2_length;
            projection_computation_result_2_length = VectorisedArithmeticOperators.multiplySIMD(lineitem_vc_1, projection_computation_result_1, projection_computation_result_1_length, ordinal_6_val_mask, ordinal_6_val_mask_length, projection_computation_result_2);
            int projection_literal_1 = 1;
            int projection_computation_result_3_length;
            projection_computation_result_3_length = VectorisedArithmeticOperators.addSIMD(projection_literal_1, lineitem_vc_3, ordinal_6_val_mask, ordinal_6_val_mask_length, projection_computation_result_3);
            int projection_computation_result_4_length;
            projection_computation_result_4_length = VectorisedArithmeticOperators.multiplySIMD(projection_computation_result_2, projection_computation_result_2_length, projection_computation_result_3, projection_computation_result_3_length, ordinal_6_val_mask, ordinal_6_val_mask_length, projection_computation_result_4);
            ...
            for (int aviv = 0; aviv < recordCount; aviv++) {
                ...
                aggregation_state_map.incrementForKey(lineitem_vc_4.get(aviv), lineitem_vc_5.get(aviv), groupKeyPreHashVector[aviv], lineitem_vc_0.get(aviv), lineitem_vc_1.get(aviv), projection_computation_result_0[aviv], projection_computation_result_4[aviv], 1, lineitem_vc_2.get(aviv));
            }
        }
        ...
        while (current_key_offset < number_of_records) {
            ...
            projection_computation_result_5_length = VectorisedArithmeticOperators.divideSIMD(agg_G_SUM_0_vector, aggregationResultVectorLength, agg_G_COUNT_4_vector, aggregationResultVectorLength, projection_computation_result_5);
            int projection_computation_result_6_length;
            projection_computation_result_6_length = VectorisedArithmeticOperators.divideSIMD(agg_G_SUM_1_vector, aggregationResultVectorLength, agg_G_COUNT_4_vector, aggregationResultVectorLength, projection_computation_result_6);
            int projection_computation_result_7_length;
            projection_computation_result_7_length = VectorisedArithmeticOperators.divideSIMD(agg_G_SUM_5_vector, aggregationResultVectorLength, agg_G_COUNT_4_vector, aggregationResultVectorLength, projection_computation_result_7);
