...
public class VectorisedSimd {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while (customer.loadNextBatch()) {
            ...
            VectorisedHashOperators.constructPreHashKeyVectorSIMD(pre_hash_vector_0, customer_vc_0, ordinal_6_val_mask, ordinal_6_val_mask_length, false);
        ...
        while (orders.loadNextBatch()) {
            ...
            VectorisedHashOperators.constructPreHashKeyVectorSIMD(pre_hash_vector_0, orders_vc_1, ordinal_4_val_mask, ordinal_4_val_mask_length, false);
        ...
        while (lineitem.loadNextBatch()) {
            ...
            projection_computation_result_length = VectorisedArithmeticOperators.subtractSIMD(projection_literal, lineitem_vc_6, ordinal_10_val_mask, ordinal_10_val_mask_length, projection_computation_result);
            int projection_computation_result_0_length;
            projection_computation_result_0_length = VectorisedArithmeticOperators.multiplySIMD(lineitem_vc_5, projection_computation_result, projection_computation_result_length, ordinal_10_val_mask, ordinal_10_val_mask_length, projection_computation_result_0);
            VectorisedHashOperators.constructPreHashKeyVectorSIMD(pre_hash_vector, lineitem_vc_0, ordinal_10_val_mask, ordinal_10_val_mask_length, false);
