package benchmarks.aggregation_query_hard_coded.NonVectorisedNonSimdSupport;

import evaluation.general_support.hashmaps.Int_Hash_Function;

import java.util.Arrays;

public final class KeyValueMap_2022012779 {
    ...
    public KeyValueMap_2022012779() {
        this(4);
    }
    public KeyValueMap_2022012779(int capacity) {
