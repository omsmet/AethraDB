...
public class VectorisedNonSimdReducedSelVecUse_Merged_Between_Predicates {
    ...
    public void trialSetup() throws Exception {
        ...
        this.expectedSumResult = switch (datasetIdentifier) {
            ...
            default -> throw new UnsupportedOperationException(
                    "tpch.q6_hard_coded.VectorisedNonSimdReducedSelVecUse.trialSetup received an unexpected datasetIdentifier: " + datasetIdentifier);
        };
    }
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while (lineitem.loadNextBatch()) {
            ...
            projection_computation_result_length = VectorisedArithmeticOperators.multiply(lineitem_vc_1, lineitem_vc_2, projection_computation_result);
