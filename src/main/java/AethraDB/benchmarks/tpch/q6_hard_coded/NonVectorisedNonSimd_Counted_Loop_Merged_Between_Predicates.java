...
public class NonVectorisedNonSimd_Counted_Loop_Merged_Between_Predicates {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while (lineitem.loadNextBatch()) {
            ...
            if (recordCount == VECTOR_LENGTH) {
                for (int aviv = 0; aviv < VECTOR_LENGTH; aviv++) {
                ...
                sum += specificLengthLoop(lineitem_vc_0, lineitem_vc_1, lineitem_vc_2, lineitem_vc_3, recordCount);
                count += recordCount;
            }
        }
    ...
    private double specificLengthLoop(
            org.apache.arrow.vector.Float8Vector lineitem_vc_0,
            org.apache.arrow.vector.Float8Vector lineitem_vc_1,
            org.apache.arrow.vector.Float8Vector lineitem_vc_2,
            org.apache.arrow.vector.DateDayVector lineitem_vc_3,
            int recordCount) {
        double sum = 0;
