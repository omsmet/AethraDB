...
public class NonVectorisedNonSimd_Records {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        for (int key_i = 0; key_i < aggregation_state_map.numberOfRecords; key_i++) {
            ...
            AggregationMap_Records.MapRecord aggregation_value = aggregation_state_map.values[key_i];
            double aggregation_0_value = aggregation_value.ord_0();
            double aggregation_1_value = aggregation_value.ord_1();
            double aggregation_2_value = aggregation_value.ord_2();
            double aggregation_3_value = aggregation_value.ord_3();
            int aggregation_4_value = aggregation_value.ord_4();
            double aggregation_5_value = aggregation_value.ord_5();
