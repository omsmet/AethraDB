...
public final class AggregationMap_Records {

    public record MapRecord(double ord_0, double ord_1, double ord_2, double ord_3, int ord_4, double ord_5) {

        public MapRecord copyCrement(double ord_incr_0, double ord_incr_1, double ord_incr_2, double ord_incr_3, int ord_incr_4, double ord_incr_5) {
    ...
    public MapRecord[] values;
    private int[] hashTable;
    private int[] next;

    public AggregationMap_Records() {
        this(4);
    }
    public AggregationMap_Records(int capacity) {
        ...
        this.values = new MapRecord[capacity];
    ...
    public void incrementForKey(byte[] key_ord_0, byte[] key_ord_1, long preHash, double value_ord_0, double value_ord_1, double value_ord_2, double value_ord_3, int value_ord_4, double value_ord_5) {
        ...
        if ((index == -1)) {
            ...
            this.values[index] = new MapRecord(value_ord_0, value_ord_1, value_ord_2, value_ord_3, value_ord_4, value_ord_5);
        ...
        this.values[index] = this.values[index].copyCrement(value_ord_0, value_ord_1, value_ord_2, value_ord_3, value_ord_4, value_ord_5);
    }
    ...
    private void growArrays() {
        ...
        this.next = newNext;
        MapRecord[] new_values = new MapRecord[newSize];
