...
public class VectorisedNonSimdReducedSelVecUse_Class {
     ...
     */
    private AggregationMap_Class aggregation_state_map;
    ...
    public void trialSetup() throws Exception {
        ...
        this.aggregation_state_map = new AggregationMap_Class();
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while ((current_key_offset < number_of_records)) {
            ...
            while (currentSourceIndex < number_of_records && currentResultIndex < VECTOR_LENGTH) {
                AggregationMap_Class.MapRC values = aggregation_state_map.values[currentSourceIndex++];
