...
public class NonVectorisedNonSimd {
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        byte[] byte_array_cache = new byte[1];
        byte[] byte_array_cache_0 = new byte[1];
//        KeyValueMap_1846412426 aggregation_state_map = new KeyValueMap_1846412426();
//        ArrowTableReader lineitem = cCtx.getArrowReader(0);
        ...
        for (int key_i = 0; key_i < aggregation_state_map.numberOfRecords; key_i++) {
            AggregationMap.RecordType currentRecord = aggregation_state_map.records[key_i];
            byte[] groupKey_0 = currentRecord.key_ord_0;
            byte[] groupKey_1 = currentRecord.key_ord_1;
            double aggregation_0_value = currentRecord.value_ord_0;
            double aggregation_1_value = currentRecord.value_ord_1;
            double aggregation_2_value = currentRecord.value_ord_2;
            double aggregation_3_value = currentRecord.value_ord_3;
            int aggregation_4_value = currentRecord.value_ord_4;
            double aggregation_5_value = currentRecord.value_ord_5;
