...
import static AethraDB.evaluation.vector_support.VectorisedOperators.VECTOR_LENGTH;
...
public class VectorisedNonSimdReducedSelVecUse_Record {
     ...
     */
    private AggregationMap_Records aggregation_state_map;
    ...
    public void trialSetup() throws Exception {
        ...
        this.aggregation_state_map = new AggregationMap_Records();
    ...
    public void executeQuery(Blackhole bh) throws IOException {
        ...
        while (lineitem.loadNextBatch()) {
            ...
            // DIFF: removed selection vector
            projection_computation_result_1_length = VectorisedArithmeticOperators.subtract(projection_literal_0, lineitem_vc_2, projection_computation_result_1);
            int projection_computation_result_2_length;
            // DIFF: removed selection vector
            projection_computation_result_2_length = VectorisedArithmeticOperators.multiply(lineitem_vc_1, projection_computation_result_1, projection_computation_result_1_length, projection_computation_result_2);
            int projection_literal_1 = 1;
            int projection_computation_result_3_length;
            // DIFF: removed selection vector
            projection_computation_result_3_length = VectorisedArithmeticOperators.add(projection_literal_1, lineitem_vc_3, projection_computation_result_3);
            int projection_computation_result_4_length;
            // DIFF: removed selection vector
            projection_computation_result_4_length = VectorisedArithmeticOperators.multiply(projection_computation_result_2, projection_computation_result_2_length, projection_computation_result_3, projection_computation_result_3_length, projection_computation_result_4);
            // DIFF: removed selection vector
            VectorisedHashOperators.constructPreHashKeyVector(groupKeyPreHashVector, lineitem_vc_4, false);
            // DIFF: removed selection vector
            VectorisedHashOperators.constructPreHashKeyVector(groupKeyPreHashVector, lineitem_vc_5, true);
        ...
        while ((current_key_offset < number_of_records)) {
            ...
            while (currentSourceIndex < number_of_records && currentResultIndex < VECTOR_LENGTH) {
                AggregationMap_Records.MapRecord values = aggregation_state_map.values[currentSourceIndex++];
                agg_G_SUM_0_vector[currentResultIndex] = values.ord_0();
                agg_G_SUM_1_vector[currentResultIndex] = values.ord_1();
                agg_G_SUM_2_vector[currentResultIndex] = values.ord_2();
                agg_G_SUM_3_vector[currentResultIndex] = values.ord_3();
                agg_G_COUNT_4_vector[currentResultIndex] = values.ord_4();
                agg_G_SUM_5_vector[currentResultIndex] = values.ord_5();
                currentResultIndex++;
            }
