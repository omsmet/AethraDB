...
public final class JoinMapType0_DJO {
    ...
    public JoinMapType0_DJO() {
        this(4);
    }
    public JoinMapType0_DJO(int capacity) {
    ...
    public void associate(int key, long preHash, int record_ord_0, byte[] record_ord_1, byte[] record_ord_2, byte[] record_ord_3, double record_ord_4, byte[] record_ord_5) {
        if ((key < 0)) {
