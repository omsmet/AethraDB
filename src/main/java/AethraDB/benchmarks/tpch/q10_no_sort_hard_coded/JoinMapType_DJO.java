...
public final class JoinMapType_DJO {
    ...
    public double[][] values_record_ord_3;
    public byte[][][] values_record_ord_4;
    public byte[][][] values_record_ord_5;
    private int[] hashTable;
    private int[] next;

    public JoinMapType_DJO() {
        this(4);
    }
    public JoinMapType_DJO(int capacity) {
        ...
        this.values_record_ord_3 = new double[capacity][8];
    ...
    public void associate(int key, long preHash, byte[] record_ord_0, byte[] record_ord_1, byte[] record_ord_2, double record_ord_3, byte[] record_ord_4, byte[] record_ord_5) {
        if ((key < 0)) {
        ...
        if (!((insertionIndex < this.values_record_ord_0[index].length))) {
            ...
            double[] temp_values_record_ord_3 = new double[newValueArraysSize];
    ...
    private void growArrays() {
        ...
        double[][] new_values_record_ord_3 = new double[newSize][8];
