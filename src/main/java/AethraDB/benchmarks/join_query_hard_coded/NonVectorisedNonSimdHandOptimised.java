package AethraDB.benchmarks.join_query_hard_coded;

import AethraDB.benchmarks.join_query_hard_coded.OptimisedSupport.JoinMap0Type;
import AethraDB.benchmarks.join_query_hard_coded.OptimisedSupport.JoinMapType;
...
//            "/nvtmp/AethraTestData/join_query_int_sf20/A_B_0.6_C_0.8",
    ...
    public void executeQuery() throws IOException {
        long count = 0;
        // DIFF: hard-coded
        // KeyMultiRecordMap_495650048 join_map = new KeyMultiRecordMap_495650048();
        // KeyMultiRecordMap_108012266 join_map_0 = new KeyMultiRecordMap_108012266();
        ...
        while (table_A.loadNextBatch()) {
            ...
            for (int aviv = 0; aviv < recordCount; aviv++) {
                ...
                join_map_0.associate(ordinal_value, left_join_key_prehash, ordinal_value_0);
            }
        }
        // DIFF: hard-coded
        ...
        while (table_B.loadNextBatch()) {
            ...
            for (int aviv = 0; aviv < recordCount; aviv++) {
                ...
                for (int i = 0; i < left_join_record_count; i++) {
                    ...
                    join_map.associate(left_join_ord_0, left_join_key_prehash);
                }
            }
        }
        // DIFF: hard-coded
        ...
        while (table_C.loadNextBatch()) {
            ...
            for (int aviv = 0; aviv < recordCount; aviv++) {
                ...
                for (int i = 0; i < left_join_record_count; i++) {
                    ...
                    // System.out.println(ordinal_value);
                    count++;
                }
            }
        }
