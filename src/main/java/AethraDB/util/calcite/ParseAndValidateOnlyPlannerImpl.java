 ...
 *
 * This is an adapted instance which tries to cut down own overhead of instantiating unnecessary
 * helper methods in the context of the AethraDB engine. Mainly, it does not in
 */

package AethraDB.util.calcite;
...
/**
 * Implementation copy of {@link PlannerImpl} which has been simplified in order to reduce overhead.
 * This version only allows to parse and validate SQL queries according to a given schema.
 */
public class ParseAndValidateOnlyPlannerImpl implements Planner, RelOptTable.ViewExpander {
    ...
    public ParseAndValidateOnlyPlannerImpl(FrameworkConfig config) {
...
// Aethra edit: removed planner-initialisation code as we don't use it for optimisation purposes
...
//        }
    ...
    // CHECKSTYLE: IGNORE 2
    /** @deprecated Now {@link ParseAndValidateOnlyPlannerImpl} implements {@link RelOptTable.ViewExpander}
     * directly. */
    ...
    public class ViewExpanderImpl implements RelOptTable.ViewExpander {
        ...
        @Override public RelRoot expandView(RelDataType rowType, String queryString,
            ...
            return ParseAndValidateOnlyPlannerImpl.this.expandView(rowType, queryString, schemaPath,
                    viewPath);
        }
    }
    ...
    private enum State {
        STATE_0_CLOSED {
            @Override void from(ParseAndValidateOnlyPlannerImpl planner) {
                planner.close();
            }
        },
        STATE_1_RESET {
        ...
        void from(ParseAndValidateOnlyPlannerImpl planner) {
