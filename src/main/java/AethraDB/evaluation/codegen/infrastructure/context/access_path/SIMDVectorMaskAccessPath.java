 ...
 * {@link jdk.incubator.vector.VectorMask}.
 */
public class SIMDVectorMaskAccessPath extends AccessPath {
    ...
    /**
     * Construct an {@link SIMDVectorMaskAccessPath} instance for a specific variable name.
     ...
     */
    public SIMDVectorMaskAccessPath(String variableToAccess, QueryVariableType type) {
        super(type);
