...
public class JaninoMethodGen {
    ...
    public static void createMethod(
        ...
        createMethod(
                ...
                returnType,
                methodName,
                new Java.FunctionDeclarator.FormalParameters(JaninoGeneralGen.getLocation()),
                statements
        );
    }
    ...
    public static void createMethod(
        ...
        Java.MethodDeclarator method = new Java.MethodDeclarator(
                location,
                null,
                new Java.Modifier[] { new Java.AccessModifier(accessModifier.toString(), JaninoGeneralGen.getLocation()) },
                null,
                returnType,
                methodName,
                params,
